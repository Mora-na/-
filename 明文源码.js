...
async function handleTCPOutBound(remoteSocket, addressType, addressRemote, portRemote, rawClientData, webSocket, vlessResponseHeader, log,) {
	...
	async function retry() {
		let tcpSocket; // Moved declaration outside of conditional blocks
		if (enableSocks) {
...
function processVlessHeader(
	...
	switch (addressType) {
		...
		case 2:
			...
			break;
		case 3: { // Added curly braces for better scoping
			addressLength = 16;
 ...
 * @param {string} uuid 
 */
const uuidRegex = /^[0-9a-f]{8}-[0-9a-f]{4}-[4][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i; // Precompiled the regex
